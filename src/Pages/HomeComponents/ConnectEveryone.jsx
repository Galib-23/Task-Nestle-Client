...
const ConnectEveryone = () => {
    return (
        <div className="mt-36">
            <h2 className="text-2xl md:text-4xl font-bold text-center text-blue-400 mb-8">CONNECT EVERYONE IN ONE PLACE</h2>
            ...
            <div className='flex flex-col items-center mt-20'>
                <img className='w-full md:w-[750px]' src={connect} alt="" />
            </div>
        </div>
    );
};
