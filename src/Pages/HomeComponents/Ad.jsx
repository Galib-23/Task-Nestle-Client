...
const Ad = () => {
    return (
        <div className='mt-44'>
            ...
            <div className='bg-gray-600 bg-opacity-30 flex justify-evenly items-center p-6'>
                <img className='w-56' src={openai} alt="" />
                <img className='w-56' src={google} alt="" />
                <img className='w-56' src={facebook} alt="" />
                <img className='w-56' src={microsoft} alt="" />
            </div>
        </div>
    );
};
