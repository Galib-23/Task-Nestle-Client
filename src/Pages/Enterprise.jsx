                ...
                <div className="md:w-1/2">
                    <div role="tablist" className="tabs tabs-lifted">
                        ...
                        <div role="tabpanel" className="tab-content bg-base-100 border-base-300 rounded-box p-6">
                            <div className="hero h-full md:h-96">
                                <div className="hero-content flex-col lg:flex-row">
                                    <img src={security} className="w-24 md:max-w-sm rounded-lg" />
                                    <div>
                        ...
                        <div role="tabpanel" className="tab-content bg-base-100 border-base-300 rounded-box p-6">
                            <div className="hero h-full md:h-96">
                                <div className="hero-content flex-col lg:flex-row">
                                    <img src={scale} className="w-24 md:max-w-sm rounded-lg"/>
                                    <div>
                        ...
                        <div role="tabpanel" className="tab-content bg-base-100 border-base-300 rounded-box p-6">
                            <div className="hero h-full md:h-96">
                                <div className="hero-content flex-col lg:flex-row">
                                    <img src={analytics} className="w-24 md:max-w-sm rounded-lg" />
                                    <div>
                        ...
                        <div role="tabpanel" className="tab-content bg-base-100 border-base-300 rounded-box p-6">
                            <div className="hero h-full md:h-96">
                                <div className="hero-content flex-col lg:flex-row">
                                    <img src={compliance} className="w-24 md:max-w-sm rounded-lg" />
                                    <div>
